...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://segun@localhost/test_db'
...
class DevelopmentConfig(Config):
    ...
    '''
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://segun@localhost/development_db'
...
class ProductionConfig(Config):
    ...
    '''
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://segun@localhost/production_db'
